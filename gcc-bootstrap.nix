{ pkgs, fetchsvn, lib
, automake111, robinutils, rogmp, rompfr, rompc, rogccSrc, riscosTargetTriple
...
let
  self = with pkgs; (overrideCC stdenv gcc10Stdenv).mkDerivation rec {
    pname = "arm-unknown-riscos-gcc-bootstrap";
    version = rogccSrc.version;
    src = rogccSrc;

    nativeBuildInputs = with pkgs; [
      automake111 gcc10 autoconf264 m4 perl autogen gperf_3_0 robinutils rompfr rogmp rompc flex bison
    ];
