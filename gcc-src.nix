...
let
  self = with pkgs; (overrideCC stdenv gcc11Stdenv).mkDerivation rec {
    pname = "arm-unknown-riscos-gcc-src";
    version = "4.7.4";
    src = fetchsvn {
    ...
    phases = [ "unpackPhase" "prePatch" "patchPhase" "preConfigure" "installPhase"];

    buildInputs = with pkgs; [
      automake111 autoconf264 m4 perl autogen
    ];
    #hardeningDisable = ["format"];
    #dontUseSourceDirectory = true;
    ...
    '';
    #configureScript = "../${src.name}/configure";
    #configureFlags =
